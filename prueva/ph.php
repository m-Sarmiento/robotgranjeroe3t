<!--Este archivo me permite graficar el ph de cuarquier planta, selencionando la planta mediante GET-->
...
?>
<div id="contenedor" style="max-width:100%;height:auto;"></div>
...
chartCPU1 = new Highcharts.StockChart({
    ...
    title: {
        text: 'Gráfica pH, planta <?php echo $p ?>'
    },
    xAxis: {
        type: 'datetime'
