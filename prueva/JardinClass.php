...
class JardinTable{
    ...
    function getPlantInfo($p){
        //Creamos la consulta
        $sql = "SELECT ID,t,ph,temp,humidity FROM jardin WHERE plant=$p;";
    ...
    function getHumidityInfo($p){
        //Creamos la consulta
        $sql = "SELECT ID,t,humidity FROM jardin WHERE plant=$p;";
        //obtenemos el array con toda la información
        return $this->getArraySQL($sql);
    }

    function getPhInfo($p){
        //Creamos la consulta
        $sql = "SELECT ID,t,ph FROM jardin WHERE plant=$p;";
        //obtenemos el array con toda la información
        return $this->getArraySQL($sql);
    }
    ...
    function getTempInfo($p){
        //Creamos la consulta
        $sql = "SELECT ID,t,temp FROM jardin WHERE plant=$p;";
        //obtenemos el array con toda la información
        return $this->getArraySQL($sql);
    }
    ...
    function getImgInfo($p){
        //Creamos la consulta
        $sql = "SELECT ID,t,img FROM jardin WHERE plant=$p;";
        //obtenemos el array con toda la información
        return $this->getArraySQL($sql);
    }
